...
class ExactInference(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        #print "prior beliefs: ", self.beliefs
    ...
    def observe(self, observation, gameState):
        ...
        #print "beliefs:" , allPossible
        
        #print "most likely location:", mostLikelyPos
        "*** END YOUR CODE HERE ***"
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        "*** YOUR CODE HERE ***"
        dist = util.Counter()
        oldDist = self.beliefs
        
        
        for p in self.legalPositions:
            newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, p))
            for np in self.legalPositions:
                #print "prior dist[np]: ", dist[np]
                dist[np] += newPosDist[np] * oldDist[p]
                #print "after update dist[np]: ", dist[np]
